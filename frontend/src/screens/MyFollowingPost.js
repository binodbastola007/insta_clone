              ...
              <div className='details'>
                <div className='card-header' style={{ borderBottom: "1px solid black" }}>
                  ...
                  <div className='card-header'>
                    <div className='card-pic'>
                      <img src=
                        'https://images.unsplash.com/photo-1691389694412-266f872999c6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=534&q=80' alt='' />
                    </div>
